  ...
  return (
    <div>
      ...
      <section className="w-full pt-8 flex justify-center items-center">
        ...
        <div className="max-w-screen-lg w-4/5 relative z-10">
          ...
          <div className="flex justify-center">
            <form onSubmit={handleGuardarCambios} className="w-full md:w-1/2 rounded-md p-8 bg-black bg-opacity-80 text-white space-y-4 relative z-10">
